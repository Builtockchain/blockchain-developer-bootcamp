...
contract('Token', ([deployer, receiver, exchange]) => {
    const name = 'Builtockchain Token'
    const symbol = 'BUILT'
    const decimals = '18'
    ...
    describe('delegated token transfers', () => {
        ...
        describe('failure', () => {
            ...
            it('rejects insufficient balances', () => {
                ...
                token.transferFrom(deployer, receiver, invalidAmount, {from: exchange}).should.be.rejected
            })

            it('rejects invalid recipients', () => {
                token.transferFrom(deployer, 0x0, amount, {from: deployer}).should.be.rejected
            })
        }) 
    })
